...
export default function AuthPage() {
  ...
  return (
    <main className="min-h-screen flex flex-col items-center justify-center p-4 bg-gradient-to-br from-gray-900 to-purple-900 text-gray-200">
      <div className="w-full max-w-md">
        <Link
          href="/"
          className="inline-flex items-center text-gray-300 mb-6 hover:text-purple-400 transition-colors"
        >
          <ArrowLeft className="mr-2 h-4 w-4" />
          Volver al inicio
        </Link>

        <Card className="w-full border border-purple-900/50 bg-gray-800/50 backdrop-blur-sm">
          <CardHeader className="space-y-1 border-b border-purple-900/50">
